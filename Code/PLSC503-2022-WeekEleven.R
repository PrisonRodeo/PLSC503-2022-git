...
library(plotrix)
# install.packages("margins") # <- as needed
library(margins)
# install.packages("gmodels") # <- as needed
library(gmodels)
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/NAFTA.csv")
