####################################################
# PLSC 503 -- Spring 2022: Code for week six
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/flintstones.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/NewDahl.csv")
NewDahl<-read.csv(text=temp, header=TRUE)
rm(temp)
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/IRData.csv")
