...
# ordinal-level outcomes... (this week, 
# the topic of ordinal-response models was 
# covered by Ilayda Onder).
#
##########################################
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/ANES-pilot-2016.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2022-git/master/Data/Beer.csv")
